...
function start() {
  ...
  //criando novas divs pelo comando append()
  ...
  //keydown há uma tecla pressionada
  $(document).keydown(function (e) {
    jogo.pressionou[e.which] = true;
  });

  //keyup não há tecla pressionada
  ...
  //responsável por movimentar o fundo do jogo
  function movefundo() {
  ...
  function movejogador() {
    if (jogo.pressionou[TECLA.W]) {
      ...
      $("#jogador").css("top", topo - 10); //( -10 = sobe 10 unidades)
      if (topo <= 0) {
  ...
  function moveinimigo2() {
    ...
    if (posicaoX <= 0) {
      $("#inimigo2").css("left", 775); //reposiciona a direita ao chegar no 0
    }
  }
  ...
  function disparo() {
    if (podeAtirar == true) {
      somDisparo.play();
      podeAtirar = false; //impede novo tiro enquanto a função não acaba a execução.
  ...
  function colisao() {
    ...
    // jogador com o inimigo de número 2
    ...
    // Disparo com o inimigo de número 1
    ...
    // Disparo com o inimigo de número 2
  ...
  function reposicionaInimigo2() {
    var tempoColisao4 = window.setInterval(reposiciona4, 5000); //após 5 segundos
